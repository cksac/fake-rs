...
impl Data for TR_TR {
    const NAME_FIRST_NAME: &'static [&'static str] = &[
        "Ahmet", "Mehmet", "Mustafa", "Ali", "Hüseyin", "Hasan", "Ayşe", "Fatma", "Emine",
        "Hatice", "Zeynep", "Elif", "Murat", "Can", "Kemal", "Burak", "Serkan", "Onur", "Ece",
        "Derya", "Selin", "Ceren", "Büşra", "Merve",
    ];

    const NAME_LAST_NAME: &'static [&'static str] = &[
        "Yılmaz", "Kaya", "Demir", "Çelik", "Şahin", "Yıldız", "Aydın", "Öztürk", "Arslan",
        "Doğan", "Kılıç", "Aslan", "Çetin", "Koç", "Polat", "Aksoy", "Erdoğan",
    ];

    const NAME_TITLE: &'static [&'static str] = &["Sn.", "Dr.", "Prof.", "Doç.", "Av.", "Müh."];
    ...
    const ADDRESS_CITY_PREFIX: &'static [&'static str] = &["Merkez", "Yeni", "Eski"];

    const ADDRESS_CITY_SUFFIX: &'static [&'static str] = &["Mahallesi", "Köyü", "Beldesi"];
