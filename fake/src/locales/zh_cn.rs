...
impl Data for ZH_CN {
    ...
    const JOB_SENIORITY: &'static [&'static str] = &["领导级", "高级", "初级", "首席级", "负责人级"];
    const JOB_FIELD: &'static [&'static str] = &["市场", "程序员", "会计师", "管理员", "广告", "银行", "社区服务", "建设", "咨询", "设计", "教育", "农业", "政府", "医疗", "招待", "法律", "制造", "采矿", "房地产", "零售", "销售", "技术"];
    const JOB_POSITION: &'static [&'static str] = &["主管", "执行", "联络", "主任", "经理", "工程师", "专员", "主任", "协调员", "行政", "建筑师", "分析师", "设计师", "策划人", "管事员", "技术员", "开发商", "制作人", "顾问", "助理", "调解人", "代理", "代表", "战略家"];
