...
check_determinism! { l10d CommerceColor; String, fake_commerce_color_en, fake_commerce_color_fr, fake_commerce_color_cn, fake_commerce_color_tw, fake_commerce_color_jp, fake_commerce_color_br, fake_commerce_color_de, fake_commerce_color_it, fake_commerce_color_cy, fake_commerce_color_nl }
check_determinism! { l10d CommerceDepartment; String, fake_commerce_department_en, fake_commerce_department_fr, fake_commerce_department_cn, fake_commerce_department_tw, fake_commerce_department_jp, fake_commerce_department_br, fake_commerce_department_de, fake_commerce_department_it, fake_commerce_department_cy, fake_commerce_department_nl }
check_determinism! { l10d CommerceProductMaterial; String, fake_commerce_product_material_en, fake_commerce_product_material_fr, fake_commerce_product_material_cn, fake_commerce_product_material_tw, fake_commerce_product_material_jp, fake_commerce_product_material_br, fake_commerce_product_material_de, fake_commerce_product_material_it, fake_commerce_product_material_cy, fake_commerce_product_material_nl }
check_determinism! { l10d CommerceProductAdjective; String, fake_commerce_product_adjective_en, fake_commerce_product_adjective_fr, fake_commerce_product_adjective_cn, fake_commerce_product_adjective_tw, fake_commerce_product_adjective_jp, fake_commerce_product_adjective_br, fake_commerce_product_adjective_de, fake_commerce_product_adjective_it, fake_commerce_product_adjective_cy, fake_commerce_product_adjective_nl }
check_determinism! { l10d CommerceProductType; String, fake_commerce_product_type_en, fake_commerce_product_type_fr, fake_commerce_product_type_cn, fake_commerce_product_type_tw, fake_commerce_product_type_jp, fake_commerce_product_type_br, fake_commerce_product_type_de, fake_commerce_product_type_it, fake_commerce_product_type_cy, fake_commerce_product_type_nl }
check_determinism! { l10d CommerceProduct; String, fake_commerce_product_en, fake_commerce_product_fr, fake_commerce_product_cn, fake_commerce_product_tw, fake_commerce_product_jp, fake_commerce_product_br, fake_commerce_product_de, fake_commerce_product_it, fake_commerce_product_cy, fake_commerce_product_nl }
check_determinism! { l10d CommerceProductPrice; String, fake_commerce_product_price_en, fake_commerce_product_price_fr, fake_commerce_product_price_cn, fake_commerce_product_price_tw, fake_commerce_product_price_jp, fake_commerce_product_price_br, fake_commerce_product_price_de, fake_commerce_product_price_it, fake_commerce_product_price_cy, fake_commerce_product_price_nl, 0.0..1000.0 }
check_determinism! { l10d CommercePromotionCode; String, fake_commerce_promotion_code_en, fake_commerce_promotion_code_fr, fake_commerce_promotion_code_cn, fake_commerce_promotion_code_tw, fake_commerce_promotion_code_jp, fake_commerce_promotion_code_br, fake_commerce_promotion_code_de, fake_commerce_promotion_code_it, fake_commerce_promotion_code_cy, fake_commerce_promotion_code_nl, 8 }
